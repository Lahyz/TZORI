document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        pt: {
            ...
            "footer-copy": "© 2026 TZORI — TZORI — Transformação Digital e Sistemas Empresariais. <br> Todos os direitos reservados."
        },
        en: {
            ...
            "pos-tag": "OUR FOCUS", "pos-title": "We don't sell software.", "pos-desc": "We sell control, productivity, and scalability. Software is just the tool we use to transform business processes into faster, organized, and profitable operations.",
        ...
        es: {
            ...
            "pos-tag": "NUESTRO ENFOQUE", "pos-title": "No vendemos software.", "pos-desc": "Vendemos control, productividad y escalabilidad. El software es solo la herramienta que utilizamos para transformar procesos en operaciones más rápidas y rentables.",
